        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "The Name of the Category.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Unique Identifier for the city."),
                    Name = table.Column<string>(type: "nvarchar(56)", maxLength: 56, nullable: false, comment: "The name of the city."),
                    CountryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Identifier of the Country.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rating = table.Column<double>(type: "float", nullable: false, comment: "The Rating of the Place."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Identifier of the Place")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersPlaces", x => new { x.ApplicationUserId, x.PlaceId });
                    table.ForeignKey(
